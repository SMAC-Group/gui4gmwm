...
[![Travis-CI Build Status](https://travis-ci.org/SMAC-Group/gui4gmwm.svg?branch=master)](https://travis-ci.org/SMAC-Group/gui4gmwm) [![Project Status: Active](http://www.repostatus.org/badges/latest/active.svg)](http://www.repostatus.org/#active) [![Licence](https://img.shields.io/badge/licence-CC%20BY--NC--SA%204.0-blue.svg)](https://www.gnu.org/licenses/gpl-3.0.en.html) [![minimal R version](https://img.shields.io/badge/R%3E%3D-3.4.0-6666ff.svg)](https://cran.r-project.org/) [![CRAN](http://www.r-pkg.org/badges/version/gui4gmwm)](https://cran.r-project.org/package=gui4gmwm) [![packageversion](https://img.shields.io/badge/Package%20version-0.1.0-orange.svg?style=flat-square)](commits/develop) [![Last-changedate](https://img.shields.io/badge/last%20change-2017--09--20-yellowgreen.svg)](/commits/master)
...
The online platform can be accessed by visiting the webpage [ggmwm.smac-group.com](http://ggmwm.smac-group.com)

![](man/figures/gui_screenshot.png)
...
install.packages(c("scales", "reshape", "shiny", "shinydashboard", "leaflet"))
...
<a href="http://creativecommons.org/licenses/by-nc-sa/4.0/"><img src="man/figures/licence.png" align="left" width="200"/></a>
